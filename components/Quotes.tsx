        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="glass-card rounded-3xl p-6 border border-bc1-lime/20 relative overflow-hidden h-fit">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full mt-6 relative z-10">
              <a href="#" className="flex-1 flex items-center justify-center gap-2 bg-[#F8F9FA] text-[#1A1A1A] px-3 py-2 rounded-xl shadow-[0_4px_14px_rgba(0,0,0,0.05)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.1)] hover:scale-105 transition-all border border-gray-100">
