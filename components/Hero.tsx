      ...
      <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="flex flex-col items-start space-y-8 max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto pt-4">
            <a href="#" className="flex items-center justify-center sm:justify-start gap-2 bg-[#F8F9FA] text-[#1A1A1A] px-4 py-2 rounded-xl shadow-[0_4px_14px_rgba(0,0,0,0.05)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.1)] hover:scale-105 transition-all border border-gray-100">
